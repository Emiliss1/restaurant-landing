                  ...
                  {index < 3 ? (
                    ...
                    >
                      ...
                      <div className="flex mt-auto justify-center">
                        <button
                          onClick={() => navigate(`/news/${item.hashTitle}`)}
          ...
          <div className="w-5/6 flex flex-col lg:flex-row lg:gap-y-0 gap-y-8 gap-4 items-center justify-around">
            <div className="text-zinc-100 w-11/12  sm:w-120 breal-all flex flex-col items-center sm:items-start gap-2">
              ...
              <p className="text-zinc-200 break-all w-5/6">
                ...
                sequi eum non, et suscipit dolorem ipsum, culpa excepturi eaque
                quibusdam sit. Deleniti, tenetur doloremque ad culpa nisi
                suscipit! Sed, porro.
              </p>
              <button
            ...
            >
              {dishes.length > 0 &&
                dishes.map((dish, index) => (
                  <div key={index} className="h-80 w-64 xs:w-68 bg-zinc-900">
                    <img
                      className="h-64 w-full object-cover"
                      src={dish.image}
                    />
                    <p className="text-center py-2 font-medium">{dish.title}</p>
                  </div>
                ))}
            </div>
          </div>
